...
import de.berlin.fu.data.dto.SensorHasPropertytypePk;
import de.berlin.fu.data.exceptions.SensorHasPropertytypeDaoException;

public class SensorHasPropertytypeDaoImpl extends AbstractDAO implements
		SensorHasPropertytypeDao {
	/**
	 ...
	 * queries
	 */
	protected final String SQL_SELECT = "SELECT Sensor_idSensor, PropertyType_idPropertyType FROM "
			+ getTableName() + "";
	...
	protected final String SQL_INSERT = "INSERT INTO "
			+ getTableName()
			+ " ( Sensor_idSensor, PropertyType_idPropertyType ) VALUES ( ?, ? )";
	...
	protected final String SQL_UPDATE = "UPDATE "
			+ getTableName()
			+ " SET Sensor_idSensor = ?, PropertyType_idPropertyType = ? WHERE Sensor_idSensor = ? AND PropertyType_idPropertyType = ?";
	 ...
	 */
	public SensorHasPropertytypePk insert(SensorHasPropertytype dto)
		...
		try {
			...
			_e.printStackTrace();
			throw new SensorHasPropertytypeDaoException("Exception: "
					+ _e.getMessage(), _e);
		} finally {
	 ...
	 */
	public void update(SensorHasPropertytypePk pk, SensorHasPropertytype dto)
			throws SensorHasPropertytypeDaoException {
		long t1 = System.currentTimeMillis();
		// declare variables
		final boolean isConnSupplied = (userConn != null);
	 ...
	 */
	public void delete(SensorHasPropertytypePk pk)
			throws SensorHasPropertytypeDaoException {
		long t1 = System.currentTimeMillis();
		// declare variables
		final boolean isConnSupplied = (userConn != null);
	...
	/**
	 * Returns the rows from the Sensor_has_PropertyType table that matches the
	 * specified primary-key value.
	 */
	public SensorHasPropertytype findByPrimaryKey(SensorHasPropertytypePk pk)
			throws SensorHasPropertytypeDaoException {
		return findByPrimaryKey(pk.getSensorIdsensor(),
				pk.getPropertytypeIdpropertytype());
	}

	/**
	 * Returns all rows from the Sensor_has_PropertyType table that match the
	 * criteria 'Sensor_idSensor = :sensorIdsensor AND
	 * PropertyType_idPropertyType = :propertytypeIdpropertytype'.
	 */
	public SensorHasPropertytype findByPrimaryKey(String sensorIdsensor,
			int propertytypeIdpropertytype)
			throws SensorHasPropertytypeDaoException {
		SensorHasPropertytype ret[] = findByDynamicSelect(
				SQL_SELECT
						+ " WHERE Sensor_idSensor = ? AND PropertyType_idPropertyType = ?",
	 ...
	 * criteria ''.
	 */
	public SensorHasPropertytype[] findAll()
			throws SensorHasPropertytypeDaoException {
		return findByDynamicSelect(SQL_SELECT
				+ " ORDER BY Sensor_idSensor, PropertyType_idPropertyType",
				null);
	}

	/**
	 * Returns all rows from the Sensor_has_PropertyType table that match the
	 * criteria 'PropertyType_idPropertyType = :propertytypeIdpropertytype'.
	 */
	public SensorHasPropertytype[] findByPropertyType(
			int propertytypeIdpropertytype)
			throws SensorHasPropertytypeDaoException {
		return findByDynamicSelect(SQL_SELECT
	 ...
	 */
	public SensorHasPropertytype[] findBySensor(String sensorIdsensor)
			throws SensorHasPropertytypeDaoException {
	 ...
	 * criteria 'Sensor_idSensor = :sensorIdsensor'.
	 */
	public SensorHasPropertytype[] findWhereSensorIdsensorEquals(
			String sensorIdsensor) throws SensorHasPropertytypeDaoException {
		return findByDynamicSelect(SQL_SELECT
	 ...
	 * criteria 'PropertyType_idPropertyType = :propertytypeIdpropertytype'.
	 */
	public SensorHasPropertytype[] findWherePropertytypeIdpropertytypeEquals(
			int propertytypeIdpropertytype)
			throws SensorHasPropertytypeDaoException {
	 ...
	 */
	protected SensorHasPropertytype fetchSingleResult(ResultSet rs)
			throws SQLException {
		if (rs.next()) {
	 ...
	 */
	protected SensorHasPropertytype[] fetchMultiResults(ResultSet rs)
			throws SQLException {
		Collection<SensorHasPropertytype> resultList = new ArrayList<SensorHasPropertytype>();
		while (rs.next()) {
			SensorHasPropertytype dto = new SensorHasPropertytype();
			populateDto(dto, rs);
			resultList.add(dto);
		...
		SensorHasPropertytype ret[] = new SensorHasPropertytype[resultList
				.size()];
	 ...
	 */
	protected void populateDto(SensorHasPropertytype dto, ResultSet rs)
			throws SQLException {
	 ...
	 */
	public SensorHasPropertytype[] findByDynamicSelect(String sql,
			Object[] sqlParams) throws SensorHasPropertytypeDaoException {
		// declare variables
		final boolean isConnSupplied = (userConn != null);
		Connection conn = null;
		PreparedStatement stmt = null;
	 ...
	 * specified arbitrary SQL statement
	 */
	public SensorHasPropertytype[] findByDynamicWhere(String sql,
			Object[] sqlParams) throws SensorHasPropertytypeDaoException {
		// declare variables
		final boolean isConnSupplied = (userConn != null);
		Connection conn = null;

...
calls to this DAO, otherwise a new Connection will be allocated for each operation.
	 ...
	 */
	protected final String SQL_SELECT = "SELECT idEvent, EventType_idEventType, Timestamp, Sensor_idSensor, Trigger_idTrigger FROM " + getTableName() + "";
	 ...
	 */
	protected final String SQL_INSERT = "INSERT INTO " + getTableName() + " ( idEvent, EventType_idEventType, Timestamp, Sensor_idSensor, Trigger_idTrigger ) VALUES ( ?, ?, ?, ?, ? )";

	/** 
	 * SQL UPDATE statement for this table
	 */
	protected final String SQL_UPDATE = "UPDATE " + getTableName() + " SET idEvent = ?, EventType_idEventType = ?, Timestamp = ?, Sensor_idSensor = ?, Trigger_idTrigger = ? WHERE idEvent = ? AND EventType_idEventType = ?";

	/** 
	 * SQL DELETE statement for this table
	 */
	protected final String SQL_DELETE = "DELETE FROM " + getTableName() + " WHERE idEvent = ? AND EventType_idEventType = ?";
	...
	{
		Event ret[] = findByDynamicSelect( SQL_SELECT + " WHERE idEvent = ? AND EventType_idEventType = ?", new Object[] {  new Integer(idEvent),  new Integer(eventtypeIdeventtype) } );
	...
	{
		return findByDynamicSelect( SQL_SELECT + " ORDER BY idEvent, EventType_idEventType", null );
	}
	...
	{
		return findByDynamicSelect( SQL_SELECT + " WHERE idEvent = ? ORDER BY idEvent", new Object[] {  new Integer(idEvent) } );
	}

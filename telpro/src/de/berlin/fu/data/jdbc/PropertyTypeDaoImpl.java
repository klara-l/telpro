...
calls to this DAO, otherwise a new Connection will be allocated for each operation.
	 ...
	 */
	protected final String SQL_SELECT = "SELECT idPropertyType, Name FROM " + getTableName() + "";
	 ...
	 */
	protected final String SQL_INSERT = "INSERT INTO " + getTableName() + " ( idPropertyType, Name ) VALUES ( ?, ? )";

	/** 
	 * SQL UPDATE statement for this table
	 */
	protected final String SQL_UPDATE = "UPDATE " + getTableName() + " SET idPropertyType = ?, Name = ? WHERE idPropertyType = ?";

	/** 
	 * SQL DELETE statement for this table
	 */
	protected final String SQL_DELETE = "DELETE FROM " + getTableName() + " WHERE idPropertyType = ?";
	...
	public PropertyTypePk insert(PropertyType dto) throws PropertyTypeDaoException
	{
		...
		try {
			...
			_e.printStackTrace();
			throw new PropertyTypeDaoException( "Exception: " + _e.getMessage(), _e );
		}
		finally {
	...
	{
		PropertyType ret[] = findByDynamicSelect( SQL_SELECT + " WHERE idPropertyType = ?", new Object[] {  new Integer(idPropertyType) } );
	...
	{
		return findByDynamicSelect( SQL_SELECT + " ORDER BY idPropertyType", null );
	}
	...
	{
		return findByDynamicSelect( SQL_SELECT + " WHERE idPropertyType = ? ORDER BY idPropertyType", new Object[] {  new Integer(idPropertyType) } );
	}
	 ...
	 */
	protected PropertyType[] fetchMultiResults(ResultSet rs) throws SQLException
	{
	 ...
	 */
	protected void populateDto(PropertyType dto, ResultSet rs) throws SQLException
	{
